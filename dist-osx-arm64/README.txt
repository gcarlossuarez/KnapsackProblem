...
2. Verá la aplicación: KnapsackProblem-osx-arm64.app
...
4. Si el sistema aún bloquea la ejecución, puede habilitarla desde Terminal:
   chmod +x "KnapsackProblem-osx-arm64.app/Contents/MacOS/KnapsackProblem"
   xattr -d com.apple.quarantine "KnapsackProblem-osx-arm64.app"
